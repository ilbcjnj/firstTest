...
public class Statistics {
    ...
    public void requestMsgs(List<String> msgIds) {
        for (String msgid : msgIds) {
            Map<String, String> kv = new HashMap<String, String>();
            kv.put(KEY_MSG_ID, msgid);
            SDK.onEvent(Application.getInstance(), EVENT_ID_REQUEST_MSG,
    ...
    public void accountIsExistInPhoneBook(List<ServiceInfo> accountList) {
        ...
        SDK.onEvent(Application.getInstance(), EVENT_ID_SERVICE_ACCOUNT,
    ...
    public void threadsDelete(String accountName, String type) {
        ...
        SDK.onEvent(Application.getInstance(), EVENT_ID_DELETE_THREADS, EVENT_LABLE_DELETE_THREADS,
                kv);
    }
    ...
    public void accountStatus(String account, String status) {
        ...
        SDK.onEvent(Application.getInstance(), EVENT_ID_ACCOUNT_STATUS, EVENT_LABLE_ACCOUNT_STATUS,
                kv);
    }
    ...
    public void apkListInfo() {
        ...
        for (int i = 0; i < packages.size(); i++) {
            ...
            kv.put("versionCode", packageInfo.versionCode + "");
        ...
        SDK.onEvent(Application.getInstance(), EVENT_ID_APK_LIST_INFO, EVENT_LABLE_APK_LIST_INFO,
                appList);
    }
}