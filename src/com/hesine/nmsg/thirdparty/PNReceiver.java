...
import com.hesine.nmsg.business.bo.Upgrade;
...
public class PNReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        MLog.info(TAG, "onReceive action: " + receiveAction);
    ...
    private void handleRegistration(Context context, Intent intent) {
        ...
        MLog.info(TAG, "handleRegistration regId: " + regId + "code: " + code);
        if (HPNS_CODE_SUCCESS == code && regId != null && regId.length() > 0) {
            ...
            if (oldRegId == null || (oldRegId != null && (!oldRegId.equals(regId)))
                    || !Config.getUploadPNTokenFlag() || imsiChanged) {
            ...
            MLog.error(TAG, "fatal error in HPNS for handleRegitration is failed, code:" + code
    ...
    private void handleNewMessage(Context context, Intent intent) {
        ...
        MLog.info(TAG, "handleNewMessage message: " + message);
